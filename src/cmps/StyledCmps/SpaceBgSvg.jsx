...
{/*<!-- symbol definition -->*/}
	...
	<svg role="presentation" className="comet-01 comet-instance" width="195" height="173.05" viewBox="0 0 195 173.05">
		<use xlinkHref="#comet" />
	</svg>

	<svg role="presentation" className="comet-02 comet-instance" width="195" height="173.05" viewBox="0 0 195 173.05">
		<use xlinkHref="#comet" />
	</svg>

	<svg role="presentation" className="comet-03 comet-instance" width="195" height="173.05" viewBox="0 0 195 173.05">
		<use xlinkHref="#comet" />
	</svg>

	<svg role="presentation" className="comet-04 comet-instance" width="195" height="173.05" viewBox="0 0 195 173.05">
		<use xlinkHref="#comet" />
	</svg>

	<svg role="presentation" className="comet-05 comet-instance" width="195" height="173.05" viewBox="0 0 195 173.05">
		<use xlinkHref="#comet" />
	</svg>

	<svg role="presentation" className="comet-06 comet-instance" width="195" height="173.05" viewBox="0 0 195 173.05">
		<use xlinkHref="#comet" />
	</svg>
</div>

<div className="sun-sys-container">
				...
				<g className="system-earth-moon-container">
					<g id="system-earth" className="system-earth-moon">
						...
						<g id="earth" className="system-earth">
							<circle id="Shadow-2-2" className="earth-shadow-02" cx="700" cy="255.79" r="95.31" />
							<circle id="Shadow-1-2" className="earth-shadow-01 cls-5" cx="699.31" cy="256.48" r="76.5" />
						...
						<g id="system-moonlight" className="system-moonlight">
							...
							<g id="moon-system-center">
								<circle id="moon-system-bg" className="moon-center" cx="700" cy="92.85" r="20.47" />
